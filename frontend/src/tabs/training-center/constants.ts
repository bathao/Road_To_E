...
const POSE: Record<string, string> = {
  ...
  gyro_ball: "wrist-curl",
  thigh_lift_bottle: "supine-leg-raise",
  db_trunk_twist: "standing-twist",
  db_shoulder_press: "scapular-yt",
  db_wood_chop: "standing-twist",
  db_lateral_raise: "scapular-yt",
  db_shadow_swing: "standing-twist",
  db_bent_row: "hip-hinge",
  db_seated_leg_press: "seated-leg-press",
  db_seated_overhead_tuck: "seated-overhead-tuck",
  db_seated_leg_spread: "seated-leg-spread",
  db_seated_pass_under: "seated-pass-under",
