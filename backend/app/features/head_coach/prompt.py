...
RECAP_SYSTEM_PROMPT = (
    ...
    "- MỤC TIÊU HIỆN TẠI của học trò: cọ xát với nhiều ĐỐI THỦ MỚI (người chưa "
    "từng gặp trước đó). Số 'đối thủ mới lần đầu gặp' được cấp sẵn — khen khi "
    "tăng, nhắc thẳng khi cả kỳ chỉ quanh quẩn đối thủ quen.\n"
